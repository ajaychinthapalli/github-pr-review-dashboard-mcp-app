 ...
 */
registerAppTool(server, "list-pull-requests", {
    ...
    try {
        ...
        const prsWithReviews = await Promise.all(pullRequests.map(async (pr) => {
            try {
 ...
 */
registerAppTool(server, "approve-pr", {
 ...
 * @returns {Promise<object>} Success or error message
 */
registerAppTool(server, "request-changes", {
 ...
 * @returns {Promise<object>} Success or error message
 */
registerAppTool(server, "comment-on-pr", {
    title: "Comment on PR",
 ...
 * @returns {Promise<object>} Success or error message
 */
registerAppTool(server, "merge-pr", {
